...
![](Images/9af21cb9-55b2-4dc1-8b1d-878b4e3622ed.png)

系统允许您选择几个参数来学习下一站的当前位置和时间预测。在屏幕的右侧，有一个指向谷歌地图混搭的链接，显示了特定路线的交通跟踪数据，如下图所示:

![](Images/624abf09-c442-4370-88ed-9a586eb84972.png)
...
![](Images/71778fe8-ec15-4e7a-96f6-767d10ebeb4c.png)
...
![](Images/c70b792f-51a9-45ae-a35d-bb152171205e.png)
...
![](Images/a39f31c3-a584-430b-89ba-8af09ac5ed71.png)
...
![](Images/c228131d-66db-41f5-8c00-5c42b22efbb2.png)

我们现在有了获取底图和天气数据的数据源。我们想把这些图像结合起来，画出公共汽车的当前位置。这次，我们将不再使用简单的点，而是变得更加复杂，并添加以下总线图标:

![](Images/c064e817-54d8-4b76-91db-aad622f3b828.png)
...
![](Images/5cda48cd-bba9-4174-bade-c1577c918866.png)
...
![](Images/c4cf73ba-0a9f-45f8-be5b-25e5cd783c08.png)
