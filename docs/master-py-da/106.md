...
![Bayes formula](images/image_06_033.jpg)
...
![Bayes formula](images/image002-300x94.jpg)
...
![Getting the NTSB database](images/image_06_003.jpg)
...
![Getting the NTSB database](images/image_06_004.jpg)
...
![Getting the NTSB database](images/image_06_005.jpg)
...
![Getting the NTSB database](images/image_06_006.jpg)
...
![Binning the data](images/image_06_007.jpg)
...
![Binning the data](images/image_06_008.jpg)
...
![Binning the data](images/image_06_009.jpg)
...
![Bayesian analysis of the data](images/image_06_010.jpg)
...
![Bayesian analysis of the data](images/image_06_011.jpg)
...
![Bayesian analysis of the data](images/image_06_012.jpg)

该函数将这三件事绘制在一个图形中。这对于快速评估结果非常方便。看所有的情节很重要；他们给出了跑步进展如何的线索:

![Bayesian analysis of the data](images/image_06_013.jpg)

对于每个随机变量，绘制轨迹、自相关和后验分布:

![Bayesian analysis of the data](images/image_06_014.jpg)
...
![Bayesian analysis of the data](images/image_06_015.jpg)
...
![Bayesian analysis of the data](images/image_06_016.jpg)
...
![Binning by month](images/image_06_017.jpg)
...
![Binning by month](images/image_06_018.jpg)
...
![Cartopy](images/image_06_019.jpg)
...
![Mpl toolkits – basemap](images/image_06_020.jpg)
...
![Getting the data](images/image_06_021.jpg)
...
![Getting the data](images/image_06_022.jpg)
...
![Getting the data](images/image_06_023.jpg)
...
![Creating and sampling the model](images/image_06_024.jpg)
...
![Creating and sampling the model](images/image_06_025.jpg)
...
![Creating and sampling the model](images/image_06_026.jpg)
...
![Creating and sampling the model](images/image_06_027.jpg)

轨迹、后验分布和自相关图看起来都非常好——清晰、明确的峰值和稳定的时间序列。截距变量也是如此:

![Creating and sampling the model](images/image_06_028.jpg)
...
![Creating and sampling the model](images/image_06_029.jpg)
...
![Creating and sampling the model](images/image_06_030.jpg)
...
![Creating and sampling the model](images/image_06_031.jpg)
...
![Creating and sampling the model](images/image_06_032.jpg)
