...
![An example using the Pandas library](images/01.jpg)
...
![An example using the Pandas library](images/03.jpg)
...
![An example using the Pandas library](images/02.jpg)
...
![An example using the Pandas library](images/04.jpg)
...
![An example using the Pandas library](images/05.jpg)
