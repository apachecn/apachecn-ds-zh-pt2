...
观察结果，我们可以说，睡眠开始后平均不使用解脱应对和平均不醒来的人花费 30 分钟或更多时间入睡的概率为-3.6。我们可以使用反向链接函数![$$ \frac{1}{1+{e}^{-\mu }} $$](../images/439480_1_En_12_Chapter/439480_1_En_12_Chapter_TeX_IEq1.png)，将此转化为概率。在`R`中，我们可以使用`plogis()`函数来完成。
